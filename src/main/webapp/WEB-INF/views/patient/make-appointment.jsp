            ...
            <div class="perfil-main-col">
                ...
                <div class="perfil-row">
                    ...
                    <div class="cell-row">
                        ...
                        <c:if test="${(hasSlotForDoctor==false) and (hasSelectDoctor==true)}"><button type="submit" class="btn btn-blue" formaction="/patient/waitingAppointment/ask">Entrar em lista de espera para Marcação</button></c:if>
                    </div>
