                    ...
                    <form class="registration-form" action="/registrationToLogin" method="post"
                        ...
                        <div class="perfil-main-col">
                            ...
                            <div>
                                ...
                                <p class="nota">O Centro Hospital UPskill é a entidade responsável pela recolha e tratamento dos dados pessoais dos Utentes. </p>

                                <p class="nota">Os dados pessoais recolhidos serão conservados de forma a permitir a sua identificação apenas durante o período necessário para a prossecução das finalidades de recolha ou do tratamento posterior, findo o qual os mesmos serão eliminados. </p>

                                <p class="nota">O Utente assume que os dados recolhidos foram inseridos pelo respetivo titular e que a sua inserção foi autorizada pelo mesmo, sendo os mesmos verdadeiros e exatos.</p>
                        ...
                        <div class="perfil-row">
                            <div class="cell-row">
                                <button class="btn btn-blue">Imprimir</button>
                            </div>
                             <div class="cell-row">
