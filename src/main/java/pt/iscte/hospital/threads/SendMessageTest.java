...
public class SendMessageTest {
    ...
    public void sendMessages() {
        ...
        Message msg33 = new Message("Peças", "Spam... por favor apague <a href=´https://www.publico.pt' class='btn btn-link'>clique aqui</a>", user3);
        Message msg34 = new Message("Peças", "Spam... por favor apague <a href='https://www.publico.pt' class='btn btn-link'>clique aqui</a>", user3);
        Message msg35 = new Message("Peças", "Spam... por favor apague <a href='https://www.publico.pt' class='btn btn-link'>clique aqui</a>", user3);
        Message msg36 = new Message("Peças", "Spam... por favor apague <a href='https://www.publico.pt' class='btn btn-link'>clique aqui</a>", user3);
